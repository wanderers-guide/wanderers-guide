...
export default function CharBuilderHome(props: { pageHeight: number }) {
  ...
  const openConfirmLevelChangeModal = (oldLevel: number, newLevel: number) =>
    modals.openConfirmModal({
      ...
      children: (
        <Text size="sm">
          Are you sure you want to decrease your character's level? Any
          selections you've made at levels higher than the new level will be
          erased.
        </Text>
      ),
      ...
      return {
        ...
        content_sources: {
          ...
          enabled: enabled
            ...
            : prev.content_sources?.enabled?.filter(
                (id: number) => id !== bookId
              ),
        },
      };
  ...
  return (
    <Stack gap={topGap}>
                  ...
                  rightSection={
                    <HoverCard width={280} shadow="md" openDelay={750}>
                      ...
                      <HoverCard.Dropdown>
                        ...
                        <Text size="sm">
                          Produces a random name and title based on your
                          character stats.
                        ...
                        >
                          ...
                          <Image
                            onClick={() =>
                              window.open("https://fantasygen.dev/")
                            }
      ...
      <Group
        ...
        align="flex-start"
        wrap="nowrap"
        h={props.pageHeight - height - topGap}
      >
            ...
            <ScrollArea h="100%">
              <Tabs defaultValue="books">
                <Tabs.List>
                  ...
                  <Tabs.Tab
                    value="variants"
                    leftSection={<IconVocabulary style={iconStyle} />}
                  >
                    Variant Rules
                  </Tabs.Tab>
                  <Tabs.Tab
                  ...
                  <Stack gap={0} pt="sm">
                    ...
                    <LinksGroup
                      ...
                      onEnableAll={() => {
                        books
                          .filter(
                            (book) => book.group === "standalone-adventure"
                          )
                          .forEach((book) => {
                            setBookEnabled(book.id, true);
                          });
          ...
          >
            <Stack>
              ...
              <ColorInput
                ...
                defaultValue={
                  character?.details?.sheet_theme?.color || GUIDE_BLUE
                }
                swatches={[
                  "#25262b",
                  "#868e96",
