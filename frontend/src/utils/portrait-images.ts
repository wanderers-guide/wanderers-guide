...
const imageStore: Record<string, ImageOption[]> = {
  general: [
    ...
    {
      name: 'Jax',
      url: 'https://fdrjqcyjklatdrmjdnys.supabase.co/storage/v1/object/public/portraits/default/7d6c357a-5646-45c9-85d3-50bd2cb67a78.jpg',
    },
    {
      name: 'Neela',
    ...
    {
      name: 'Vitruvius',
      url: 'https://fdrjqcyjklatdrmjdnys.supabase.co/storage/v1/object/public/portraits/default/a2c6eb81-df19-42a2-9972-4a7abc428dd7.jpg',
    },
    {
      name: 'Raylin',
    ...
    {
      name: 'Isabella',
      url: 'https://fdrjqcyjklatdrmjdnys.supabase.co/storage/v1/object/public/portraits/default/7e6ad4e6-8cfa-4088-9069-2330165a811e.png',
    },
    {
      name: 'Drolak',
