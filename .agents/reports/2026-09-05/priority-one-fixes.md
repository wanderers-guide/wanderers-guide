...
- Infrastructure regressions: 55 passed, including actual controllers, worker transport failures, concurrent requests, account changes and the real save hook. Immediate Wizard selection followed by navigation preserves the class and newer remote notes/version; invalid draft baselines and acknowledgement races are covered.
