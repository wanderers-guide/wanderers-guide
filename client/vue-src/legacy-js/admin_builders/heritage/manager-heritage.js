...
$(function () {
    ...
    for(const entry of entries){
        ...
        cardEdit.click(function() {
            window.location.href = '/admin/edit/heritage/'+heritageID;
        });
    ...
    $('#delete-confirmation-btn').click(function() {
        socket.emit("requestAdminRemoveHeritage", activeModalHeritageID);
    });

}); 

socket.on("returnAdminRemoveHeritage", function() {
