...
$(function () {
    ...
    socket.emit("requestAdminArchetypeDetails");

});

socket.on("returnAdminArchetypeDetails", function(archetypeArray, featsObject){

    let featMap = objToMap(featsObject);
    
    let archetypeID = getArchetypeEditorIDFromURL();
    ...
    $("#inputVersion").val(archetype.version);
    ...
    $("#inputContentSource").val(archetype.contentSrc);
