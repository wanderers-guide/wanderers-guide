...
function finishClassFeature(isUpdate){
    ...
    let classFeatureID = $('#builder-container').attr('data-class-feature-id');
    if(isUpdate){
        requestPacket = "requestHomebrewUpdateClassFeature";
    } else {
        requestPacket = "requestHomebrewAddClassFeature";
    }
...
socket.on("returnHomebrewCompleteClassFeature", function() {
