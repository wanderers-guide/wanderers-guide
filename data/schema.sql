...
\restrict LI9UNPaHt1q3YbVJ5kdgZWiv8nCMZSUqhI3wNf9ONNA4EKaOhEueiSDUveF9TDb
...
CREATE TABLE public.ability_block (
    ...
    search_tsv tsvector GENERATED ALWAYS AS ((setweight(to_tsvector('english'::regconfig, (COALESCE(name, ''::character varying))::text), 'A'::"char") || setweight(to_tsvector('english'::regconfig, (COALESCE(description, ''::character varying))::text), 'B'::"char"))) STORED,
...
--
-- Name: campaign_join_grant; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.campaign_join_grant (
    user_id uuid NOT NULL,
...
ALTER TABLE public.campaign_join_grant OWNER TO postgres;
...
--
-- Name: edge_work_budget; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.edge_work_budget (
    resource text NOT NULL,
    actor text NOT NULL,
    window_start date NOT NULL,
    used bigint DEFAULT 0 NOT NULL,
    CONSTRAINT edge_work_budget_actor_check CHECK (((length(actor) >= 1) AND (length(actor) <= 80))),
    CONSTRAINT edge_work_budget_resource_check CHECK ((resource = ANY (ARRAY['ai'::text, 'vector-query'::text, 'vector-populate'::text]))),
    CONSTRAINT edge_work_budget_used_check CHECK ((used >= 0))
);


ALTER TABLE public.edge_work_budget OWNER TO postgres;
...
--
-- Name: campaign_join_grant campaign_join_grant_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.campaign_join_grant
    ADD CONSTRAINT campaign_join_grant_pkey PRIMARY KEY (user_id, campaign_id);
...
--
-- Name: edge_work_budget edge_work_budget_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.edge_work_budget
    ADD CONSTRAINT edge_work_budget_pkey PRIMARY KEY (resource, actor);
...
--
-- Name: ability_block_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ability_block_description_trgm_idx ON public.ability_block USING gin (description public.gin_trgm_ops);
...
CREATE INDEX ability_block_name_trgm_idx ON public.ability_block USING gin (name public.gin_trgm_ops);


--
-- Name: ability_block_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ability_block_search_tsv_idx ON public.ability_block USING gin (search_tsv);
...
--
-- Name: ancestry_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ancestry_name_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ancestry_name_trgm_idx ON public.ancestry USING gin (name public.gin_trgm_ops);


--
-- Name: ancestry_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ancestry_search_tsv_idx ON public.ancestry USING gin (search_tsv);
...
--
-- Name: archetype_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX archetype_description_trgm_idx ON public.archetype USING gin (description public.gin_trgm_ops);
...
CREATE INDEX archetype_name_trgm_idx ON public.archetype USING gin (name public.gin_trgm_ops);


--
-- Name: archetype_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX archetype_search_tsv_idx ON public.archetype USING gin (search_tsv);
...
--
-- Name: background_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: background_name_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX background_name_trgm_idx ON public.background USING gin (name public.gin_trgm_ops);


--
-- Name: background_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX background_search_tsv_idx ON public.background USING gin (search_tsv);
...
--
-- Name: class_archetype_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX class_archetype_description_trgm_idx ON public.class_archetype USING gin (description public.gin_trgm_ops);
...
CREATE INDEX class_archetype_name_trgm_idx ON public.class_archetype USING gin (name public.gin_trgm_ops);


--
-- Name: class_archetype_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX class_archetype_search_tsv_idx ON public.class_archetype USING gin (search_tsv);
...
--
-- Name: class_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: class_name_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX class_name_trgm_idx ON public.class USING gin (name public.gin_trgm_ops);


--
-- Name: class_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX class_search_tsv_idx ON public.class USING gin (search_tsv);
...
CREATE INDEX creature_search_tsv_idx ON public.creature USING gin (search_tsv);


--
-- Name: edge_work_budget_window_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX edge_work_budget_window_idx ON public.edge_work_budget USING btree (window_start);
...
--
-- Name: item_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX item_description_trgm_idx ON public.item USING gin (description public.gin_trgm_ops);
...
CREATE INDEX item_name_trgm_idx ON public.item USING gin (name public.gin_trgm_ops);


--
-- Name: item_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX item_search_tsv_idx ON public.item USING gin (search_tsv);
...
--
-- Name: language_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: language_name_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX language_name_trgm_idx ON public.language USING gin (name public.gin_trgm_ops);


--
-- Name: language_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX language_search_tsv_idx ON public.language USING gin (search_tsv);
...
--
-- Name: spell_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX spell_description_trgm_idx ON public.spell USING gin (description public.gin_trgm_ops);
...
--
-- Name: spell_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX spell_search_tsv_idx ON public.spell USING gin (search_tsv);
...
--
-- Name: trait_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX trait_description_trgm_idx ON public.trait USING gin (description public.gin_trgm_ops);
...
CREATE INDEX trait_name_trgm_idx ON public.trait USING gin (name public.gin_trgm_ops);


--
-- Name: trait_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX trait_search_tsv_idx ON public.trait USING gin (search_tsv);
...
--
-- Name: versatile_heritage_description_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: versatile_heritage_name_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX versatile_heritage_name_trgm_idx ON public.versatile_heritage USING gin (name public.gin_trgm_ops);


--
-- Name: versatile_heritage_search_tsv_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX versatile_heritage_search_tsv_idx ON public.versatile_heritage USING gin (search_tsv);
...
--
-- Name: ability_block ability_block_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER ability_block_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.ability_block FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: ability_block ability_block_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER ability_block_set_updated_at BEFORE UPDATE ON public.ability_block FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: ancestry ancestry_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER ancestry_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.ancestry FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: ancestry ancestry_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER ancestry_set_updated_at BEFORE UPDATE ON public.ancestry FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: archetype archetype_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER archetype_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.archetype FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: archetype archetype_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER archetype_set_updated_at BEFORE UPDATE ON public.archetype FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: background background_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER background_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.background FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: background background_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER background_set_updated_at BEFORE UPDATE ON public.background FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: character character_campaign_membership; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER character_campaign_membership BEFORE INSERT OR UPDATE ON public."character" FOR EACH ROW EXECUTE FUNCTION public.enforce_character_campaign_membership();


--
-- Name: character character_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER character_set_updated_at BEFORE UPDATE ON public."character" FOR EACH ROW EXECUTE FUNCTION public.set_character_updated_at();


--
-- Name: class_archetype class_archetype_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER class_archetype_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.class_archetype FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: class_archetype class_archetype_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER class_archetype_set_updated_at BEFORE UPDATE ON public.class_archetype FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: class class_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER class_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.class FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: class class_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER class_set_updated_at BEFORE UPDATE ON public.class FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: content_source content_source_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER content_source_set_updated_at BEFORE UPDATE ON public.content_source FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: creature creature_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER creature_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.creature FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: creature creature_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER creature_set_updated_at BEFORE UPDATE ON public.creature FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: item item_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER item_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.item FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: item item_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER item_set_updated_at BEFORE UPDATE ON public.item FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: language language_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER language_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.language FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: language language_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER language_set_updated_at BEFORE UPDATE ON public.language FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: spell spell_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER spell_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.spell FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: spell spell_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER spell_set_updated_at BEFORE UPDATE ON public.spell FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: trait trait_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trait_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.trait FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: trait trait_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trait_set_updated_at BEFORE UPDATE ON public.trait FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();


--
-- Name: versatile_heritage versatile_heritage_bump_source_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER versatile_heritage_bump_source_updated_at AFTER INSERT OR DELETE OR UPDATE ON public.versatile_heritage FOR EACH ROW EXECUTE FUNCTION public.bump_content_source_updated_at();


--
-- Name: versatile_heritage versatile_heritage_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER versatile_heritage_set_updated_at BEFORE UPDATE ON public.versatile_heritage FOR EACH ROW EXECUTE FUNCTION public.set_content_updated_at();
...
--
-- Name: campaign_join_grant campaign_join_grant_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.campaign_join_grant
    ADD CONSTRAINT campaign_join_grant_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.campaign(id) ON DELETE CASCADE;


--
-- Name: campaign_join_grant campaign_join_grant_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.campaign_join_grant
    ADD CONSTRAINT campaign_join_grant_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
...
CREATE POLICY "Enable insert for authenticated users only" ON public."character" FOR INSERT TO authenticated WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: campaign_join_grant; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: edge_work_budget; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
GRANT INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.campaign TO anon;
GRANT INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.campaign TO authenticated;
GRANT ALL ON TABLE public.campaign TO service_role;
GRANT ALL ON TABLE public.campaign TO github;


--
-- Name: COLUMN campaign.id; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(id) ON TABLE public.campaign TO anon;
GRANT SELECT(id) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.created_at; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(created_at) ON TABLE public.campaign TO anon;
GRANT SELECT(created_at) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.user_id; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(user_id) ON TABLE public.campaign TO anon;
GRANT SELECT(user_id) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.name; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(name) ON TABLE public.campaign TO anon;
GRANT SELECT(name) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.description; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(description) ON TABLE public.campaign TO anon;
GRANT SELECT(description) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.notes; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(notes) ON TABLE public.campaign TO anon;
GRANT SELECT(notes) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.recommended_options; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(recommended_options) ON TABLE public.campaign TO anon;
GRANT SELECT(recommended_options) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.recommended_variants; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(recommended_variants) ON TABLE public.campaign TO anon;
GRANT SELECT(recommended_variants) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.recommended_content_sources; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(recommended_content_sources) ON TABLE public.campaign TO anon;
GRANT SELECT(recommended_content_sources) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.custom_operations; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(custom_operations) ON TABLE public.campaign TO anon;
GRANT SELECT(custom_operations) ON TABLE public.campaign TO authenticated;


--
-- Name: COLUMN campaign.meta_data; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(meta_data) ON TABLE public.campaign TO anon;
GRANT SELECT(meta_data) ON TABLE public.campaign TO authenticated;
...
--
-- Name: TABLE campaign_join_grant; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.campaign_join_grant TO anon;
GRANT ALL ON TABLE public.campaign_join_grant TO authenticated;
GRANT ALL ON TABLE public.campaign_join_grant TO service_role;
...
GRANT SELECT ON TABLE public.content_update TO anon;
GRANT SELECT ON TABLE public.content_update TO authenticated;
...
--
-- Name: TABLE edge_work_budget; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.edge_work_budget TO service_role;
...
--
-- Name: COLUMN public_user.id; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(id) ON TABLE public.public_user TO anon;
GRANT SELECT(id) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.created_at; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(created_at) ON TABLE public.public_user TO anon;
GRANT SELECT(created_at) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.user_id; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(user_id) ON TABLE public.public_user TO anon;
GRANT SELECT(user_id) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.display_name; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(display_name) ON TABLE public.public_user TO anon;
GRANT SELECT(display_name) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.image_url; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(image_url) ON TABLE public.public_user TO anon;
GRANT SELECT(image_url) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.background_image_url; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(background_image_url) ON TABLE public.public_user TO anon;
GRANT SELECT(background_image_url) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.site_theme; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(site_theme) ON TABLE public.public_user TO anon;
GRANT SELECT(site_theme) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.is_admin; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(is_admin) ON TABLE public.public_user TO anon;
GRANT SELECT(is_admin) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.is_mod; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(is_mod) ON TABLE public.public_user TO anon;
GRANT SELECT(is_mod) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.deactivated; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(deactivated) ON TABLE public.public_user TO anon;
GRANT SELECT(deactivated) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.summary; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(summary) ON TABLE public.public_user TO anon;
GRANT SELECT(summary) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.subscribed_content_sources; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(subscribed_content_sources) ON TABLE public.public_user TO anon;
GRANT SELECT(subscribed_content_sources) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.organized_play_id; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(organized_play_id) ON TABLE public.public_user TO anon;
GRANT SELECT(organized_play_id) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.is_developer; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(is_developer) ON TABLE public.public_user TO anon;
GRANT SELECT(is_developer) ON TABLE public.public_user TO authenticated;


--
-- Name: COLUMN public_user.is_community_paragon; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT(is_community_paragon) ON TABLE public.public_user TO anon;
GRANT SELECT(is_community_paragon) ON TABLE public.public_user TO authenticated;
...
\unrestrict LI9UNPaHt1q3YbVJ5kdgZWiv8nCMZSUqhI3wNf9ONNA4EKaOhEueiSDUveF9TDb
