...
\restrict dAuvcDtqTK0pcTOHSROlE86Nj3SEo7w3qbJRddb2cNkoMek0y9gopNSHBJh4vre
...
--
-- Name: set_character_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
-- Keeps character.updated_at current for optimistic-concurrency (see supabase/migrations).
--

CREATE OR REPLACE FUNCTION public.set_character_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  new.updated_at = now();
...
ALTER FUNCTION public.set_character_updated_at() OWNER TO postgres;
...
\unrestrict dAuvcDtqTK0pcTOHSROlE86Nj3SEo7w3qbJRddb2cNkoMek0y9gopNSHBJh4vre
