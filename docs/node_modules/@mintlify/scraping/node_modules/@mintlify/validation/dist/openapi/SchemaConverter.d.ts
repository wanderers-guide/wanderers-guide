...
import { SchemaObject } from './v2/types/index.js';
export declare class SchemaConverter extends BaseConverter {
    ...
    private static readonly MAX_SCHEMA_COMBINATION_SIZE;
    private constructor();
    /**
    ...
    private shouldTruncateForSize;
    private createTruncatedNextProperties;
    private createTruncatedReducedSchema;
    private createTruncatedDataSchema;
