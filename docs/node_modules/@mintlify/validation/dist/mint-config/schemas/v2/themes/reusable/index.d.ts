export declare const standardConfigSchema: {
    ...
    contextual: import("zod").ZodOptional<import("zod").ZodObject<{
        options: import("zod").ZodEffects<import("zod").ZodArray<import("zod").ZodUnion<[import("zod").ZodEnum<["assistant", "copy", "view", "chatgpt", "claude", "perplexity", "grok", "aistudio", "devin", "windsurf", "mcp", "add-mcp", "cursor", "vscode", "devin-mcp"]>, import("zod").ZodObject<{
