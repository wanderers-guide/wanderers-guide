...
export const ANTHROPIC_REGULAR_MODELS = ['claude-haiku-4-5-20251001'];
export const ANTHROPIC_MODELS = [...ANTHROPIC_PREMIUM_MODELS, ...ANTHROPIC_REGULAR_MODELS];
export const OPENAI_PREMIUM_MODELS = ['gpt-4.1-2025-04-14', 'gpt-4o-2024-08-06', 'gpt-5'];
...
export const WRITER_MODELS = ['palmyra-x5'];
